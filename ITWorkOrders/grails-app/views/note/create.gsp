	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<!-- Do not need notes list here<li><g:link class="list" action="index"><g:message code="default.list.label" args="[entityName]" /></g:link></li>-->
			</ul>
		</div>
		<div id="create-note" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:noteInstance, action:'save']" >
				<fieldset class="form">
