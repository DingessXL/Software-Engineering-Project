	...
	<body>
		...
		<div id="show-ticket" class="content scaffold-show" role="main">
			...
			<ol class="property-list ticket">
				...
				<li class="fieldcontain">
					<span id="reply-label" class="property-label"><g:message code="ticket.reply.label" default="Reply" /></span>
						...
						<!--<span class="property-value" aria-labelledby="reply-label"><g:link controller="reply" action="show" id="${r.id}">${r?.encodeAsHTML()}</g:link></span>-->
							<span class="property-value" aria-labelledby="reply-label"><g:link controller="reply" action="show" id="${r.id}">${r.author} said:</g:link><br />
								${r.reply} <br /><br />
								<i>Reply Date: ${r.dateCreated}</i><br />  <!-- Need to format this date--></span>
						</g:each>
				...
				<li class="fieldcontain">
					<!-- Changing default= to Notes from grails autogenerated Note -->
					<span id="note-label" class="property-label"><g:message code="ticket.note.label" default="Notes" /></span>
						...
						<g:each in="${ticketInstance.note}" var="n">
							<span class="property-value" aria-labelledby="note-label"><g:link controller="note" action="show" id="${n.id}">${n.author} said:</g:link><br />
								${n.note} <br /><br />
								<i>Note Date: ${n.dateCreated}</i><br />  <!-- Need to format this date-->
							</span>
						</g:each>
