	...
	<body>
		...
		<div id="show-note" class="content scaffold-show" role="main">
			...
			<ol class="property-list note">
				...
				<g:if test="${noteInstance?.user}">
				<li class="fieldcontain">
					<span id="user-label" class="property-label"><g:message code="note.user.label" default="User" /></span>
					
						<span class="property-value" aria-labelledby="user-label"><g:fieldValue bean="${noteInstance}" field="user"/></span>
