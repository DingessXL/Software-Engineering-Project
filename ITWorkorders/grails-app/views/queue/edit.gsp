...
<html>
	...
	<body>
		<a href="#edit-queue" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-queue" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:queueInstance, action:'update']" method="PUT" >
