		...
		<div id="list-ticket" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="ticket.technician.label" default="Assigned Technician" /></th>
					
						<th><g:message code="ticket.priority.label" default="Priority" /></th>
				...
				<g:each in="${ticketInstanceList}" status="i" var="ticketInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: ticketInstance, field: "priority")}</td>
