		...
		<div id="list-workGroup" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="name" title="${message(code: 'workGroup.name.label', default: 'Name')}" />
				...
				<g:each in="${workGroupInstanceList}" status="i" var="workGroupInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${workGroupInstance.id}">${fieldValue(bean: workGroupInstance, field: "name")}</g:link></td>
